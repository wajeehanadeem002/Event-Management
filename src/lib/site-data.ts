...
export const eventCategories: EventCategory[] = [
  {
    ...
    icon: "heart",
    gradient: "from-purple via-pink to-peach",
  ...
  },
  {
    ...
    icon: "gift",
    gradient: "from-purple via-pink to-gold",
  ...
  },
  {
    ...
    icon: "baby",
    gradient: "from-mint via-peach to-pink",
  ...
  },
  {
    ...
    icon: "sparkles",
    gradient: "from-gold via-peach to-purple",
  ...
  },
  {
    ...
    icon: "building",
    gradient: "from-foreground via-purple to-pink",
