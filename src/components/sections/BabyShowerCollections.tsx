...
const babyShowerCollections = [
  {
    title: "Soft Pastel Shower",
    badge: "BABY SHOWER",
    image: "/baby1.jpg",
    description: "Gentle pastel inspiration with balloons, florals, dessert tables, and family-friendly styling.",
    accent: "from-coral-blush to-rose-flame",
  },
  {
    title: "Garden Baby Brunch",
    badge: "BRUNCH",
    image: "/baby2.jpg",
    description: "Fresh daytime setups with soft tablescapes, playful stations, and airy celebration details.",
    accent: "from-olive-grove to-coral-blush",
  },
  {
    title: "Welcome Baby Party",
    badge: "WELCOME",
    image: "/baby3.jpg",
    description: "Warm welcome-baby boards with cozy decor, photo moments, favors, and joyful guest flow.",
    accent: "from-spiced-orange to-rose-flame",
  },
];

export function BabyShowerCollections() {
  return (
    <section className="bg-background py-16 sm:py-24">
      <Container>
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {babyShowerCollections.map((collection, index) => (
              ...
              <article className="group overflow-hidden rounded-[2rem] bg-white shadow-[0_24px_70px_rgba(140,3,28,0.1)] ring-1 ring-border transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_80px_rgba(140,3,28,0.16)]">
                <div className="relative aspect-[4/3] overflow-hidden bg-foreground">
                  ...
                  <div className="absolute left-4 top-4 inline-flex items-center gap-2 rounded-full bg-white/90 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.16em] text-foreground backdrop-blur">
                    <Baby className="h-3.5 w-3.5 text-rose-flame" aria-hidden="true" />
                    {collection.badge}
                  </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-muted">
                Pair a soft palette, snack table, welcome sign, and family photo moment for a complete shower board.
              </p>
            </div>
